...
class Customer(PinYinFieldModelMixin, models.Model):
    ...
    job = models.CharField(_(u'职业'), max_length=255, blank=True)
    monthly_income = models.CharField(_(u'收入'), choices=INCOME_CHOICES, max_length=50, blank=True)
    weixin_id = models.CharField(_(u'微信号'), max_length=255, blank=True)
    address = models.CharField(_(u'地址'), max_length=512, blank=True)
    remark = models.CharField(_(u'备注'), max_length=512, blank=True)
