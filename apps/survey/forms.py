...
class SurveyFillForm(forms.ModelForm):
    ...
    non_score_question2 = forms.ChoiceField(widget=forms.RadioSelect(), label='51. 日间-洁面',
                                            choices=(('洗面奶洁面1次', 'A. 洁面产品洁面1次'),
                                                     ('清水洗脸', 'B. 清水洗脸（不用任何洁面产品）'),
                                                     ('不洁面', 'C. 不洁面'),
                                                     ('其它', 'D. 其它'),))  # todo 如选择d，请备注具体情况：
    non_score_question3 = forms.ChoiceField(widget=forms.RadioSelect(), label='52. 日间-化妆水',
                                            choices=(('使用', 'A. 使用'),
                                                     ('不使用', 'B. 不使用'),
                                                     ('喷雾代替', 'C. 喷雾代替'),
                                                     ('先用肌底液再用化妆水',
                                                      'D. 先用肌底液再用化妆水'),))
    non_score_question4 = forms.ChoiceField(widget=forms.RadioSelect(), label='53. 日间-精华',
                                            choices=(('使用', 'A. 使用'),
                                                     ('不使用', 'B. 不使用'),
                                                     ('其它产品代替',
                                                      'C. 其它产品代替')))  # todo 如选择c，请备注具体情况：
    non_score_question5 = forms.ChoiceField(widget=forms.RadioSelect(), label='54. 日间-乳液或面霜',
                                            choices=(('使用', 'A. 使用'),
                                                     ('不使用', 'B. 不使用'),
                                                     ('两个都用', 'C. 两个都用'),
                                                     ('其它产品代替',
                                                      'D. 其它产品代替'),))  # todo 如选择d，请备注具体情况：
    non_score_question6 = forms.ChoiceField(widget=forms.RadioSelect(), label='55.日间-防晒',
                                            choices=(('四季每日使用，不管阴天晴天', 'A. 四季每日使用，不管阴天晴天'),
                                                     ('仅仅夏季使用', 'B. 仅仅夏季使用'),
                                                     ('不固定，想起来就用', 'C. 不固定，想起来就用'),
                                                     ('用底妆产品代替', 'D. 用底妆产品代替'),
                                                     ('从来不用', 'E. 从来不用')))
    non_score_question7 = forms.ChoiceField(widget=forms.RadioSelect(), label='56. 夜间-卸妆',
                                            choices=(('使用卸妆产品', 'A. 使用'),
                                                     ('不使用卸妆产品，直接洗脸',
                                                      'B. 不使用，直接洗脸'),
                                                     ('偶尔使用卸妆产品，不固定',
                                                      'C. 偶尔使用，不固定')))
    non_score_question8 = forms.ChoiceField(widget=forms.RadioSelect(), label='57. 夜间-洁面',
                                            choices=(('洗面奶洁面1次', 'A. 洁面产品洁面1次'),
                                                     ('清水洗脸', 'B. 清水洗脸（不用任何洁面产品）'),
                                                     ('不洁面', 'C. 不洁面'),
                                                     ('其他', 'D. 其他'),))  # todo 如选择d，请备注具体情况：
    non_score_question9 = forms.ChoiceField(widget=forms.RadioSelect(), label='58. 夜间-化妆水',
                                            choices=(('使用', 'A. 使用'),
                                                     ('不使用', 'B. 不使用'),
                                                     ('喷雾代替', 'C. 喷雾代替'),
                                                     ('先用肌底液再用化妆水',
                                                      'D. 先用肌底液再用化妆水'),))
    non_score_question10 = forms.ChoiceField(widget=forms.RadioSelect(), label='59. 夜间-精华',
                                             choices=(('使用', 'A. 使用'),
                                                      ('不使用', 'B. 不使用'),
                                                      ('其它产品代替',
                                                       'C. 其它产品代替')))  # todo 如选择c，请备注具体情况：
    non_score_question11 = forms.ChoiceField(widget=forms.RadioSelect(), label='60. 夜间-乳液或面霜',
                                             choices=(('使用', 'A. 使用'),
                                                      ('不使用', 'B. 不使用'),
                                                      ('两个都用', 'C. 两个都用'),
