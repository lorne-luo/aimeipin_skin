    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('return_code', models.CharField(blank=True, choices=[('FAIL', 'FAIL'), ('SUCCESS', 'SUCCESS')], max_length=16)),
                ('return_msg', models.CharField(blank=True, max_length=128, null=True)),
                ('result_code', models.CharField(blank=True, choices=[('FAIL', 'FAIL'), ('SUCCESS', 'SUCCESS')], max_length=16)),
                ...
                ('sign_type', models.CharField(blank=True, default='MD5', max_length=32)),
                ...
                ('trade_state', models.CharField(blank=True, choices=[('SUCCESS', '支付成功'), ('REFUND', '已退款'), ('NOTPAY', '未付款'), ('CLOSED', '支付关闭'), ('REVOKED', '已撤销'), ('USERPAYING', '支付中'), ('PAYERROR', '支付失败')], max_length=32)),
